...
export const MovieListItem = (props:IMovieListItemProps) => {
    ...
    const [img, setImage] = useState<string>(props.movieCatalogueItem.imagePool[imgIndex]);
    ...
    return (
            ...
            >
              <TableCell align="right" component="th" scope="row">
                    {imgFailed ? <p></p> : <img className="cover-img"
                    onError={(i) => {
                ...
                {props.movieCatalogueItem.title}
                </TableCell>
                <TableCell align="right">
                {props.movieCatalogueItem.year}
                </TableCell>
